...
pbmrecog: main.o pbm.o kerneldesc.o
	g++ -g -fopenmp -o pbmrecog main.o pbm.o kerneldesc.o liblinear/tron.cpp liblinear/linear.cpp liblinear/blas/blas.a `pkg-config opencv matio --cflags --libs` -lhdf5 -IInclude -lboost_filesystem -lboost_system
